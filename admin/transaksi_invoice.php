...
<body>
  ...
  <div class="container">
    ...
    ?>
      ...
      <a href="transaksi_invoice_cetak.php?id_penjualan=<?php echo $id_penjualan; ?>" target="_blank" class="btn btn-primary pull-right"><i class="glyphicon glyphicon-print"></i> CETAK</a>
      <br>
      <br>
