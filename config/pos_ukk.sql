...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 26, 2024 at 04:43 PM
...
(1, 'Nur Kholis', 'Desa Dukuh Kecamatan Indramayu Kabupaten Indramayu', '083824371997');
...
(1, 'Realme 10 Pro', 1, '3500000.00', 10),
(2, 'Asus X505Z', 2, '6500000.00', 5);
...
ALTER TABLE `penjualan`
  ...
  ADD CONSTRAINT `penjualan_ibfk_4` FOREIGN KEY (`id_user`) REFERENCES `user` (`id_user`);
